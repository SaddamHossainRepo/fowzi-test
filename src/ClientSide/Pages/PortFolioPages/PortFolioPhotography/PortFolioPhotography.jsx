          ...
          >
            <div
              className="
               ...
               md:rounded-[20px]
               rounded-[15px]
                text-white bg-black relative h-full w-full object-cover  "
            >
              <div className=" h-full w-full object-cover">
                <div className="text-center md:text-left lg:text-left xl:text-left 2xl:text-left  px-[15px] md:px-0 lg:px-0 xl:px-0 2xl:px-0  md:flex lg:flex xl:flex 2xl:flex justify-center items-center h-full w-full object-cover">
                  <div
                    className="
