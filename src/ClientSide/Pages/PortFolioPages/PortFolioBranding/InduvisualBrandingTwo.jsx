  ...
  return (
    <div>
      <div>
        <div
          className=" 
                2xl:bg-[url('/betterHandHero.jpg')] 
                xl:bg-[url('/betterHandHero.jpg')]
                lg:bg-[url('/betterHandHero.jpg')]
                md:bg-[url('/betterHandHero.jpg')]
                bg-[url('/betterHandHeroMob.png')]
                
                bg-cover -center w-[100%] bg-black 
   2xl:h-[100dvh] 
   xl:h-[100dvh] 
   lg:h-[100dvh] 
   md:h-[100dvh] 
   h-[60dvh] "
      ...
      >
        <div className="brandigParent">
          ...
          <h3 className="titleSubHeading">Better Hand</h3>
          <div className="singleImgParent">
            <img
              className="h-full w-full object-cover xl:rounded-[30px] 2xl:rounded-[30px] lg:rounded-[25px] md:rounded-[20px] rounded-[15px]"
              src="/betterHand.png"
              alt=""
            />
          </div>
          <div>
            <h3 className="titleSubHeading 2xl:mt-[200px] xl:mt-[200px] lg:mt-[150px] md:mt-[100px] mt-[100px]">
              Project Description
            </h3>

            <p className="singleBrandPara">
              At the Better Hand Community, our approach is centered around
              providing exceptional care for each client. We believe that every
              individual deserves to receive compassionate care that promotes
              independence, dignity, and a high quality of life.
            </p>
            <p className="singleBrandPara">
              To achieve this, we take a client-centered approach, where we
              collaborate with our clients, their families, and healthcare
              professionals to create a personalized care plan that meets their
              specific needs and preferences.
            </p>
            <p className="singleBrandPara">
              Our team of experienced and dedicated caregivers are trained to
              deliver care with empathy, respect, and professionalism while
              ensuring the safety and comfort of our clients. We believe that
              clear and consistent communication is key to building trust and
              establishing long-lasting relationships.
            </p>
          </div>
          <div>
            <h3
              className="titleSubHeading 2xl:pt-[200px] xl:pt-[200px] lg:pt-[150px] md:pt-[100px]
                        pt-[100px] "
            >
              Color/Typography
            </h3>
            <h4 className="primaryTextBranding">Primary font</h4>
            <p className="forntLink">
              https://fonts.adobe.com/fonts/brandon-grotesque
            </p>
          </div>
          <div className="SingleBrandingImg">
            <img className=" h-full w-full" src="/brandonFont.png" alt="" />
          </div>
          <div>
            <h3
              className="titleSubHeading 2xl:pt-[200px] xl:pt-[200px] lg:pt-[150px] md:pt-[100px]
            ...
            <div className="grid grid-cols-2 2xl:gap-[50px] xl:gap-[40px] lg:gap-[30px] md:gap-[25px] gap-[20px] ">
              ...
              <div className=" 2xl:space-y-[50px] xl:space-y-[40px] lg:space-y-[30px] md:space-y-[25px] space-y-[25px] ">
                <div className="projetImgOne">
                  {/* <img className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Group328.png" alt="" /> */}
                  <img
                    className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover"
                    src="/betterHandMockup1.png"
                    alt=""
                  />
                </div>

                <div className="projetImgTwo">
                  {/* <img className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Group326.png" alt="" /> */}
                  <img
                    className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover"
                    src="/betterHandMockup2.png"
                    alt=""
                  />
                </div>

                {/* <div className="projetImgOne">
                                    <img className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/projectFive.jpeg" alt="" />
                                </div> */}
              </div>
              ...
              <div className="2xl:space-y-[50px] xl:space-y-[40px] lg:space-y-[30px] md:space-y-[25px] space-y-[25px]  ">
                <div className="projetImgTwo">
                  {/* <img className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Group327.png" alt="" /> */}
                  <img
                    className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover"
                    src="/betterHandMockup3.png"
                    alt=""
                  />
                </div>
                <div className="projetImgOne">
                  {/* <img className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/protfolioBranding/careConnect/Rectangle64.png" alt="" /> */}
                  <img
                    className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover"
                    src="/betterHandMockup4.png"
                    alt=""
                  />
                </div>
                {/* <div className="projetImgOne">
                                    <img className="w-full  h-full object-center 2xl:rounded-[30px] xl:rounded-[25px] lg:rounded-[20px] md:rounded-[15px] rounded-[10px] object-cover" src="/projectSix.jpeg" alt="" />
                                </div> */}
              </div>
            </div>
          </div>
...
export default InduvisualBrandingTwo;
