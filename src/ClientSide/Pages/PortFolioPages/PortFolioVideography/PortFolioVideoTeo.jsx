        ...
        >
          ...
          <div className="">
            <h4 className="titleSubHeading pb-[30px]">
              {/* Washington Toe Foundation Video */}
              Shamil Mirza - Real Estate - Testimonial
            </h4>
            {/* <p className="cardBaseText 2xl:pb-[60px] xl:pb-[50px] lg:pb-[40px] md:pb-[40px] pb-[20px]">
            ...
            <div className="">
              ...
              <div className="w-[100%] xl:h-[500px] 2xl:h-[700px] lg:h-[400px] md:h-[300px] h-[200px]">
                <iframe
                  title="vimeo-player"
                  // src="https://player.vimeo.com/video/879062045?h=2f06f81dd7"
                  src="https://player.vimeo.com/video/946386055?h=f8235c73dc"
                  className="w-full h-full"
                  frameBorder="0"
                  allowfullscreen
                ></iframe>

{/* <iframe title="vimeo-player" src="https://player.vimeo.com/video/946386055?h=f8235c73dc" width="640" height="360" frameborder="0"    allowfullscreen></iframe> */}
              </div>
...
export default PortFolioVideoTeo;
